...
function testLogin() {
    ...
    $url = 'https://cybaemtech.net/itsm_app/php/api/auth.php?action=login';
...
function testSession() {
    $url = 'https://cybaemtech.net/itsm_app/php/api/auth.php';
...
function testTicketCreation() {
    ...
    $postData = json_encode([
        ...
        'contact_email' => 'test@cybaemtech.net',
    ...
    $url = 'https://cybaemtech.net/itsm_app/php/api/tickets.php';
...
function testActualAccess() {
    ...
    $urls = [
        'https://cybaemtech.net/itsm_app/',
        'https://cybaemtech.net/itsm_app/php/api/auth.php',
        'https://cybaemtech.net/itsm_app/php/api/tickets.php'
    ];
