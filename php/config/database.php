...
define('DB_HOST', '82.25.105.94'); // Usually 'localhost' for cPanel
define('DB_NAME', 'cybaemtechnet_itsm_helpdesk'); // Replace with your database name
define('DB_USER', 'cybaemtechnet_itsm_helpdesk'); // Replace with your database username
define('DB_PASS', 'Cybaem@2025'); // Replace with your database password
